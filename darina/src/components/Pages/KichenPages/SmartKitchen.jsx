...
import image1 from "../../../assets/images/bg-image/smart1.png";
import image2 from "../../../assets/images/bg-image/smart2.jpeg";
import "./EmeraldKitchen.css";
import ImageCategoryKitchen from "../../Module/ImageCategoryKitchen/ImageCategoryKitchen";
import imagebg from "../../../assets/images/bg-image/smartbg.png";
...
function SmartKitchen() {
  ...
  return (
    <div id="EmeraldKitchen" className="genn-EmeraldKitchen">
      <BannerTextShadow video1={video1} video2={video2} text={"Кухня Смарт"} />
