...
import image1 from "../../../assets/images/bg-image/kitchenTop1.png";
import image2 from "../../../assets/images/bg-image/kitchenTop2.jpeg";
import "./EmeraldKitchen.css";
import "./KitchenTop.css";
import ImageCategoryKitchen from "../../Module/ImageCategoryKitchen/ImageCategoryKitchen";
import imagebg from "../../../assets/images/bg-image/kitchenTopbg.png";
...
function KitchenTop() {
  ...
  return (
    <div id="KitchenTop" className="genn-EmeraldKitchen">
      <BannerTextShadow video1={video1} video2={video2} text={"Кухня Топ"} />
      ...
      <div className="genn-VivaKitchen-imageButton">
        <div
          className="genn-VivaKitchen-imageButton-image-container  .genn-KitchenTop"
